...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    var PLATFORM_LOG_STRING = (_a$1$1 = {},
        ...
        _a$1$1[name$2] = 'fire-auth',
        _a$1$1[name$3] = 'fire-rtdb',
        _a$1$1[name$4] = 'fire-fn',
    ...
    ***************************************************************************** */
    ...
    var ma$1 = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0); } : function (a, b) { if ("string" === typeof a)
        ...
        if (c in a && a[c] === b)
            return c; return -1; }, na$1 = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c); } : function (a, b, c) { for (var d = a.length, e = "string" === typeof a ? a.split("") : a, f = 0; f < d; f++)
    ...
    function Qa$1(a) { return Ea$1(a, function () { {
        var b = 0;
        var e = ta(String(Ma$1)).split("."), f = ta(String(a)).split("."), g = Math.max(e.length, f.length);
    ...
    var db$1 = "closure_lm_" + (1E6 * Math.random() | 0), eb = {};
    ...
    function pb(a) { if ("number" !== typeof a && a && !a.Y) {
        ...
        if (b && b[A$1])
            ...
            (c = kb(b)) ? (cb(c, a), 0 == c.b && (c.src = null, b[db$1] = null)) : $a$1(a);
        }
    } }
    ...
    function kb(a) { a = a[db$1]; return a instanceof ab ? a : null; }
    ...
    r(Vb, y);
    function I$1(a) { var b = Ub(); E$1(b, new Vb(b, a)); }
            ...
            if (a == this.a)
                a: {
                    ...
                    if (!(3 > b || 3 == b && !Ia$1 && !this.a.$())) {
                        this.A || 4 != b || 7 == c || (8 == c || 0 >= d ? I$1(3) : I$1(2));
                        pc$1(this);
                        var e = this.a.W();
                        this.N = e;
                        var f = this.a.$();
                        ...
                        if (this.b) {
                            ...
                            this.I ? (sc$1(this, b, f), Ia$1 && this.b && 3 == b && (Mb(this.J, this.R, "tick", this.Wa), this.R.start())) : (G$1(this.c, this.f, f, null), qc(this, f));
                            4 == b && P$1(this);
                            this.b && !this.A && (4 == b ? uc$1(this.g, this) : (this.b = !1, mc$1(this)));
                        }
                        else
                            400 == e && 0 < f.indexOf("Unknown SID") ? (this.h = 3, J$1(12)) : (this.h = 0, J$1(13)), P$1(this), rc$1(this);
                    }
                }
        }
        catch (u) { }
    ...
    function sc$1(a, b, c) { for (var d = !0; !a.A && a.D < c.length;) {
        ...
        if (e == ic$1) {
            ...
            G$1(a.c, a.f, e, null), qc(a, e);
    } 4 == b && 0 == c.length && (a.h = 1, J$1(16), d = !1); a.b = a.b && d; d ? 0 < c.length && !a.V && (a.V = !0, b = a.g, b.a == a && b.U && !b.F && (b.c.info("Great, no buffering proxy detected. Bytes received: " + c.length), wc$1(b), b.F = !0, J$1(11))) : (G$1(a.c, a.f, c, "[Invalid Chunked Response]"), P$1(a), rc$1(a)); }
    ...
    h.cancel = function () { this.A = !0; P$1(this); };
    ...
    h.Va = function () { this.o = null; var a = q$1(); 0 <= a - this.T ? (Sb(this.c, this.l), 2 != this.H && (I$1(3), J$1(17)), P$1(this), this.h = 2, rc$1(this)) : yc$1(this, this.T - a); };
    function rc$1(a) { 0 == a.g.v || a.A || uc$1(a.g, a); }
    function P$1(a) { pc$1(a); var b = a.F; b && "function" == typeof b.ja && b.ja(); a.F = null; Hb(a.R); Nb(a.J); a.a && (b = a.a, a.a = null, b.abort(), b.ja()); }
    function qc(a, b) {
        try {
            var c = a.g;
    ...
    h.get = function (a, b) { return T$1(this.b, a) ? this.b[a] : b; };
    h.set = function (a, b) { T$1(this.b, a) || (this.c++, this.a.push(a)); this.b[a] = b; };
    h.forEach = function (a, b) { for (var c = this.L(), d = 0; d < c.length; d++) {
        var e = c[d], f = this.get(e);
        a.call(b, f, e, this);
    } };
    function T$1(a, b) { return Object.prototype.hasOwnProperty.call(a, b); }
    var Nc$1 = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^\\/?#]*)@)?([^\\/?#]*?)(?::([0-9]+))?(?=[\\/?#]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;
    ...
    U$1.prototype.toString = function () { var a = [], b = this.f; b && a.push(Vc(b, Wc, !0), ":"); var c = this.c; if (c || "file" == b)
    ...
    function Rc$1(a, b) { if (b) {
        ...
        a.h = null; }
    function Tc$1(a, b, c) { b instanceof Sc$1 ? (a.b = b, $c(a.b, a.a)) : (c || (b = Vc(b, ad)), a.b = new Sc$1(b, a.a)); }
    ...
    function ed(a, b) { V$1(a); b = W$1(a, b); T$1(a.a.b, b) && (a.c = null, a.b -= a.a.get(b).length, a = a.a, T$1(a.b, b) && (delete a.b[b], a.c--, a.a.length > 2 * a.c && Mc$1(a))); }
    function fd(a, b) { V$1(a); b = W$1(a, b); return T$1(a.a.b, b); }
    h.forEach = function (a, b) { V$1(this); this.a.forEach(function (c, d) { na$1(c, function (e) { a.call(b, e, d, this); }, this); }, this); };
    ...
    */
    ...
    }(Error), S = new Logger("@firebase/firestore");
     ...
     */ function D(t) {
        ...
        if (S.logLevel <= LogLevel.DEBUG) {
            var r = e.map(x);
            S.debug.apply(S, __spreadArray([ "Firestore (8.3.2): " + t ], r));
        }
    }
    ...
    function A(t) {
        ...
        if (S.logLevel <= LogLevel.ERROR) {
            var r = e.map(x);
            S.error.apply(S, __spreadArray([ "Firestore (8.3.2): " + t ], r));
        }
    }
    ...
    function k(t) {
        ...
        if (S.logLevel <= LogLevel.WARN) {
            var r = e.map(x);
            S.warn.apply(S, __spreadArray([ "Firestore (8.3.2): " + t ], r));
        }
    }
     ...
     */ var P = /** @class */ function() {
        ...
        return t.u = function() {
            ...
            ; n.length < 20; ) for (var r = L$1(40), i = 0; i < r.length; ++i) 
    ...
    // Visible for testing
    var dr = __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], [ Zn.store, tr.store, er.store, ir.store, sr.store, $n.store, ar.store, ur.store ]), [ hr.store ])), [ or.store ])), [ cr.store ])), [ fr.store, lr.store ]), pr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", yr = /** @class */ function() {
        function t() {
        ...
        function e(n, r, i) {
            ...
            // log on 12.2.
            12.2 === e._t(getUA()) && A("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
        }
     ...
     */ var li = /** @class */ function() {
        ...
        return t.prototype.calculateTargetCount = function(t, e) {
            ...
            return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
                ...
                return a = Date.now(), N() <= LogLevel.DEBUG && D("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - f) + "ms"), 
                mr.resolve({
                    didRun: !0,
     ...
     */
        ...
        /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
            ...
            // collection, rather than to perform individual lookups.
                ...
                var s = i.Cn(e, o);
                return (Qt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (N() <= LogLevel.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ne(e)), 
        ...
        t.prototype.Nn = function(t, e, n, r) {
            ...
            return N() <= LogLevel.DEBUG && D("QueryEngine", "Using full collection scan to execute query:", ne(e)), 
     ...
     */
            ...
            })), _(h, Event.STAT_EVENT, (function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return (e) ? [ 3 /*break*/ , 4 ] : (n.$r.add(2 /* IsSecondary */), [ 4 /*yield*/ , Po(n) ]);
     ...
     */ function Hu(t, e) {
        ...
        if (t = getModularInstance(t), Pu("collection", "path", e), t instanceof Gu) return qu(n = z.fromString.apply(z, __spreadArray([ e ], r))), 
        ...
        return qu(n = z.fromString.apply(z, __spreadArray([ t.path ], r)).child(z.fromString(e))), new Wu(t.firestore, 
        /* converter= */ null, n);
    }
     ...
     */ function Yu(t, e) {
        ...
        // 'undefined' and 'null'.
        1 === arguments.length && (e = P.u()), Pu("doc", "path", e), t instanceof Gu) return Vu(n = z.fromString.apply(z, __spreadArray([ e ], r))), 
        new zu(t, 
        /* converter= */ null, new st(n));
        if (!(t instanceof zu || t instanceof Wu)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        return Vu(n = t._path.child(z.fromString.apply(z, __spreadArray([ e ], r)))), new zu(t.firestore, t instanceof Wu ? t._converter : null, new st(n));
    }
     ...
     * Firestore database.
     */ function Xu(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), (t instanceof zu || t instanceof Wu) && (e instanceof zu || e instanceof Wu) && t.firestore === e.firestore && t.path === e.path && t._converter === e._converter
        /**
    ...
    function Ju(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), t instanceof Qu && e instanceof Qu && t.firestore === e.firestore && te(t._query, e._query) && t._converter === e._converter
        /**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     */ function Aa(t, e) {
        ...
        // from firestore-exp.
        t = getModularInstance(t))) return Ca("Unsupported field value:", e, t), ka(t, e);
        if (t instanceof ca) 
     ...
     */ function Ra(t, e, n) {
        ...
        // FieldPath.
        (e = getModularInstance(e)) instanceof ua) return e._internalPath;
     ...
     */ function La(t, e, n) {
        ...
        /* path= */ void 0, n);
        try {
            return (new (ua.bind.apply(ua, __spreadArray([ void 0 ], e.split(".")))))._internalPath;
        } catch (r) {
    ...
    function tc(t, e, n, r) {
        if (n[0] = getModularInstance(n[0]), n[0] instanceof Fa) return function(t, e, n, r, i) {
    ...
    var sc = /** @class */ function(t) {
        ...
        return t.prototype.set = function(t, e, n) {
            ...
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ua ? Na(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Sa(this._dataReader, "WriteBatch.update", s._key, e), 
     ...
     * called.
     */ function ac(t, e) {
        if ((t = getModularInstance(t)).firestore !== e) throw new T(E.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return t;
    }
     ...
     */ function hc(t, e, n) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        e = getModularInstance(e)) || e instanceof ua ? Na(s, "updateDoc", t._key, e, n, r) : Sa(s, "updateDoc", t._key, e)).toMutation(t._key, Ee.exists(!0)) ]);
    }
     ...
     */ var pc = /** @class */ function(t) {
        ...
        return t.prototype.get = function(t) {
            ...
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ua ? Na(this._dataReader, "Transaction.update", s._key, e, n, r) : Sa(this._dataReader, "Transaction.update", s._key, e), 
    ...
    var Sc = /** @class */ function() {
        ...
        return t.eu = function(e, n, r) {
            ...
            return (t = getModularInstance(t)) instanceof zu && Xu(this._delegate, t);
        }, t.prototype.set = function(t, e) {
            ...
            try {
                return 1 === arguments.length ? hc(this._delegate, t) : hc.apply(void 0, __spreadArray([ this._delegate, t, e ], n));
            } catch (t) {
     ...
     */ var Mc = /** @class */ function() {
        ...
        function t() {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            this._delegate = new (ua.bind.apply(ua, __spreadArray([ void 0 ], t)));
        }
        return t.documentId = function() {
            ...
            return (t = getModularInstance(t)) instanceof ua && this._delegate._internalPath.isEqual(t._internalPath);
        }, t;
    }(), Fc = /** @class */ function() {
        function t(t) {
            this._delegate = t;
    ...
    var I = {
        ...
        Transaction: _c,
        WriteBatch: Ec,
        DocumentReference: Sc,
        DocumentSnapshot: kc,
        Query: Cc,
        QueryDocumentSnapshot: xc,
        QuerySnapshot: Oc,
        CollectionReference: Lc,
        FieldPath: Mc,
        FieldValue: Fc,
        setLogLevel: Ic,
        CACHE_SIZE_UNLIMITED: ea
    };
     ...
     */
        function(e, r) {
            ...
            return new wc(e, new na(e, s), new gc);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Show Screen";
    			add_location(button, file, 239, 1, 6141);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*webcamInit*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h20 = element("h2");
    			h20.textContent = "Create a new Call";
    			t1 = space();
    			button0 = element("button");
    			button0.textContent = "Call";
    			t3 = space();
    			h21 = element("h2");
    			h21.textContent = "Join a Call";
    			t5 = space();
    			input = element("input");
    			t6 = space();
    			...
    			button2.textContent = "Hangup";
    			add_location(h20, file, 230, 1, 5857);
    			add_location(button0, file, 231, 1, 5885);
    			add_location(h21, file, 233, 1, 5963);
    			attr_dev(input, "id", "callInput");
    			attr_dev(input, "type", "text");
    			add_location(input, file, 234, 1, 5985);
    			add_location(button1, file, 235, 1, 6043);
    			add_location(button2, file, 237, 1, 6107);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*callId*/ ctx[1]);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*callId*/ 2 && input.value !== /*callId*/ ctx[1]) {
    				set_input_value(input, /*callId*/ ctx[1]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*webcamEnabled*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			span0 = element("span");
    			h30 = element("h3");
    			h30.textContent = "Local";
    			t5 = space();
    			video0 = element("video");
    			t6 = space();
    			span1 = element("span");
    			h31 = element("h3");
    			h31.textContent = "Remote";
    			t8 = space();
    			video1 = element("video");
    			t9 = space();
    			if_block.c();
    			document_1.title = "Boom";
    			add_location(h2, file, 213, 1, 5433);
    			attr_dev(canvas_1, "id", "canvas");
    			attr_dev(canvas_1, "width", "1280");
    			attr_dev(canvas_1, "height", "720");
    			add_location(canvas_1, file, 214, 1, 5448);
    			add_location(h30, file, 217, 3, 5538);
    			attr_dev(video0, "id", "webcamVideo");
    			video0.autoplay = "false";
    			video0.playsInline = true;
    			add_location(video0, file, 219, 3, 5605);
    			add_location(span0, file, 216, 2, 5528);
    			add_location(h31, file, 222, 3, 5687);
    			attr_dev(video1, "id", "remoteVideo");
    			video1.autoplay = "true";
    			video1.playsInline = true;
    			add_location(video1, file, 224, 3, 5755);
    			add_location(span1, file, 221, 2, 5677);
    			attr_dev(div, "class", "videos svelte-eiuazc");
    			add_location(div, file, 215, 1, 5505);
    			add_location(main, file, 212, 0, 5425);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(span0, t5);
    			append_dev(span0, video0);
    			append_dev(div, t6);
    			append_dev(div, span1);
    			append_dev(span1, h31);
    			append_dev(span1, t8);
    			append_dev(span1, video1);
    			append_dev(main, t9);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function startWebcam(remoteVideo) {
    		localStream = await startCapture({ video: { cursor: "never" }, audio: true });
    			...
    			dataChannel.addEventListener("open", event => {
    				...
    				if (!isHost) {
    					...
    					function getMousePos(canvas, evt) {
    						...
    						return {
    							x: (evt.clientX - rect.left) * (1920 / 1280),
    							y: (evt.clientY - rect.top) * (1080 / 720)
    						};
    					}
    	...
    	async function webcamInit() {
    		...
    		$$invalidate(0, webcamEnabled = true);
    	}
    	...
    	const click_handler = async () => {
    		$$invalidate(1, callId = await createOffer());
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("remoteStream" in $$props) remoteStream = $$props.remoteStream;
    		if ("dataChannel" in $$props) dataChannel = $$props.dataChannel;
    		if ("isHost" in $$props) isHost = $$props.isHost;
    		if ("canvas" in $$props) canvas = $$props.canvas;
    		if ("ws" in $$props) ws = $$props.ws;
    		if ("webcamEnabled" in $$props) $$invalidate(0, webcamEnabled = $$props.webcamEnabled);
    		if ("callId" in $$props) $$invalidate(1, callId = $$props.callId);
    	};
